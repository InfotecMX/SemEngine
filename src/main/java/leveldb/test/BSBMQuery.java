...
public class BSBMQuery
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Model model=new ModelCom(new SWBTSGraph(new GraphImp("bsbm",params)));
...
*/        
    ...
    public static void query(String query, int index, Model model)
    {
        long time=System.currentTimeMillis();        
...
//            System.out.println();
        ...
        System.out.println("query "+index+":"+x+" "+(System.currentTimeMillis()-time));   
        time=System.currentTimeMillis();        
    }
}
